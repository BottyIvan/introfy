...
// Split the tagline into individual lines, filtering out any empty or whitespace-only rows
...
<template>
  <main class="bg-gray-900 font-sans min-h-screen">
    ...
    <section class="relative flex flex-col items-center justify-center text-center min-h-[90vh] px-4 overflow-hidden">
      ...
      <!-- Decorative background gradient glow effects -->
      ...
      <div class="relative z-10 pt-10 max-w-4xl mx-auto flex flex-col items-center gap-6">
        ...
        <!-- Latest version badge or notification -->
        <LatestRelease :release="latestRelease" />

        <!-- Dynamic multi-line gradient headline -->
        ...
        <!-- Call to action download buttons container -->
        <div id="download" class="flex gap-3 flex-wrap justify-center">
          <DownloadLatest />
        </div>

        <!-- Application screenshot showcase with glowing backdrop -->
    ...
    <!-- Content Sections (Features & Release History) -->
